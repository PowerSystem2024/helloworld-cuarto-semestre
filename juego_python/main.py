...
def main() :
    ...
    imagen_inicial_path = os.path.join ( 'images' , 'icon.jpg' )
    ...
    fondo2 = pygame.image.load ( os.path.join ( 'images' , 'fondo2.jpg' ) )
    fondo2 = pygame.transform.scale ( fondo2 , (SCREEN_WIDTH , SCREEN_HEIGHT) )

    fondo3 = pygame.image.load ( os.path.join ( 'images' , 'fondo1.jpg' ) )
    ...
    sonido_laser = pygame.mixer.Sound ( os.path.join ( ASSETS_PATH , 'laserdis.mp3' ) )
    sonido_explosion = pygame.mixer.Sound ( os.path.join ( ASSETS_PATH , 'explosion.mp3' ) )

    # Reproducir sonido de fondo
    pygame.mixer.music.load ( os.path.join ( ASSETS_PATH , 'efectos.mp3' ) )
