...
class Personaje:
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load(os.path.join('images', 'personaje1.jpg'))
...
class Enemigo:
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load(os.path.join('images', 'personaje2.jpg'))
...
class Laser:
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load(os.path.join('images', 'laser.jpg'))
