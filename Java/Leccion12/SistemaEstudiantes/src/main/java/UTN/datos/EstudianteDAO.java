...
public class EstudianteDAO {
    ...
    public boolean modificarEstudiante(Estudiante estudiante){
        ...
        try{
            ...
            System.out.println("Ocurrio un error al tratar de modificar estudiante: " + e.getMessage());
        } // Fin catch
        finally{
            try{
                con.close();
            } catch (Exception e){
                System.out.println("Ocurrio un error al tratar de cerrar la conexión: " + e.getMessage());
            } // Fin catch
        } // Fin finally
        return false;
...
//        var estudianteModificado = new Estudiante(1, "Juan Carlos", "Juarez", "55446633221", "juan@mail.com.ar");
...
//            System.out.println("No se modifico el estudiante: " + estudianteModificado);
        ...
        // Agregar estudiante
//        var nuevoEstudiante = new Estudiante("Carlos", "Lara", "5495544223", "carloslara@mail.com");
//        var agregado = estudianteDao.agregarEstudiante(nuevoEstudiante);
//        if(agregado){
//            System.out.println("Estundiante agregado: " + nuevoEstudiante);
//        }
//        else {
